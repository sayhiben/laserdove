| <img src="logo.png" alt="LaserDove logo" height="26"> # laserdove | [![Python Tests](https://github.com/sayhiben/laserdove/actions/workflows/python-tests.yml/badge.svg)](https://github.com/sayhiben/laserdove/actions/workflows/python-tests.yml) [![Python Lint](https://github.com/sayhiben/laserdove/actions/workflows/python-lint.yml/badge.svg)](https://github.com/sayhiben/laserdove/actions/workflows/python-lint.yml) |
| :-- | --: |
